...
def stage_init(input_set: dict, stage: str) -> dict:
    ...
    if stage == "dev":
        input_set["inputSet"]["pipeline"]["template"]["templateInputs"]["stages"].update(parms)
    elif stage == "devz":
        input_set["inputSet"]["pipeline"]["template"]["templateInputs"]["stages"].update(parms)
    elif stage == "qaa":
        input_set["inputSet"]["pipeline"]["template"]["templateInputs"]["stages"].update(parms)
...
def add_qa_approval(input_set: dict) -> dict:
    qa_approval = {
        "stage": {
            "identifier": "Approval_for_qa",
            "type": "Approval",
    ...
    input_set["inputSet"]["pipeline"]["template"]["templateInputs"]["stages"].append(qa_approval)
    return input_set

def add_prod_approval(input_set: dict) -> dict:
    prod_approval = {
        "stage": {
            "identifier": "Approval_for_prod",
            "type": "Approval",
    ...
    input_set["inputSet"]["pipeline"]["template"]["templateInputs"]["stages"].append(prod_approval)
    
    return input_set

def add_closing_approval(input_set: dict) -> dict:
    closing_approval = {
        "stage": {
            "identifier": "Closing_Approval",
            "type": "Approval",
    ...
    input_set["inputSet"]["pipeline"]["template"]["templateInputs"]["stages"].append(closing_approval)
    
    return input_set

def add_dev_stage(input_set: dict, stage: dict) -> dict:
    ...
    input_set["inputSet"]["pipeline"]["template"]["templateInputs"]["stages"].append(stage)
    return input_set